...
class AnalysisScores:
    ...
    Attributes:
        authenticity_score: Probability that the website is authentic (0.0-1.0) or None if inconclusive
        fake_score: Probability that the website is fraudulent (0.0-1.0) or None if inconclusive
        ...
        risk_level: Standardized verdict ("SAFE", "SUSPICIOUS", "HIGH_RISK", "PHISHING", "INCONCLUSIVE")
        critical_indicators: High-severity security threat indicators
    """
    authenticity_score: Optional[float] = None
    fake_score: Optional[float] = None
